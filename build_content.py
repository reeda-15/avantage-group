...
works = '''<section class="portfolio-showcase" id="work" aria-labelledby="work-heading"><div class="portfolio-stage"><div class="portfolio-backdrop"><div class="portfolio-rail portfolio-rail-left"><span class="portfolio-pill">✳ &nbsp; FEATURED PROJECTS</span><p>Discover systems designed to make complex work clearer across multiple industries.</p></div><h1 id="work-heading">Portfolio<span>.</span></h1><span class="portfolio-rail portfolio-rail-right">08 PROJECTS <span aria-hidden="true">↗</span></span></div><div class="portfolio-cards">'''
for i,project in enumerate(PROJECTS,1):
    image = f'<img src="assets/{e(project["image"])}" alt="{e(project["title"])} project visual" loading="lazy">' if project['image'] else '<div class="portfolio-type-art">Quartzline <em>Minerals</em></div>'
    works += f'''<a class="portfolio-card" href="projects/{project['slug']}.html" data-page-link data-portfolio-card><div class="portfolio-card-media">{image}</div><div class="portfolio-card-caption"><div class="portfolio-card-top"><span>0{i} / 08</span><span>{e(project['category'])}</span></div><h2>{e(project['title'])}<span aria-hidden="true">↗</span></h2><p>{e(project['summary'])}</p></div></a>'''
works += '''</div></div><div class="portfolio-outro" id="portfolio-end"><span>03 / PROJECTS</span><span>EIGHT SYSTEMS, BUILT FOR REAL OPERATIONS</span></div></section><section class="page-cta paper-grid section-pad"><h2>Have a process we can improve?</h2><a class="pill" href="contact.html" data-page-link>Start a conversation <span aria-hidden="true">↗</span></a></section>'''
page('Work','Selected Avantage AI projects across travel, manufacturing, steel, real estate, games, minerals and marketing.',works,'works.html',active='Work',body_class='portfolio-page')
