...
def header(prefix, active=''):
    nav = [('Portfolio','works.html'),('Projects','projects.html'),('Services','services.html'),('About','about.html'),('Insights','blog.html'),('Contact','contact.html')]
...
about += '''<section class="team-section section-pad paper-grid" id="team"><div class="section-label"><span>THE PEOPLE BEHIND THE WORK</span><span class="scribble">two people, no layers</span></div><div class="team-intro"><h2>Two people.<br><mark>No layers.</mark></h2><p>Avantage AI is intentionally small. The strategist who scopes your system and the architect who builds it stay close to the work. No account managers, no handoffs, no dilution.</p></div><div class="team-grid"><article class="team-card"><div class="team-photo"><img src="assets/sumit-thakur.png" alt="Sumit Thakur" loading="lazy"></div><div class="team-card-copy"><span>01 / BUSINESS STRATEGY</span><h3>Sumit Thakur</h3><strong>Business Strategist &amp; Advisor</strong><p>15+ years in business consulting. Bridges objectives and technology so every system addresses profitability, efficiency, and growth.</p></div></article><article class="team-card"><div class="team-photo"><img src="assets/meer-sheikh.jpg" alt="Meer Sheikh" loading="lazy"></div><div class="team-card-copy"><span>02 / TECHNOLOGY</span><h3>Meer Sheikh</h3><strong>Technology Architect &amp; AI Lead</strong><p>Builds the systems. Specialises in intelligent automation, custom software, and AI architecture, with a focus on performance, reliability, and longevity.</p></div></article></div></section>'''
...
people = [
    {'name':'Sumit Thakur','role':'Business Strategist & Advisor','image':'sumit-thakur.png','summary':'15+ years in business consulting. Bridges business objectives and technology so every system improves profitability, efficiency, and growth.'},
    {'name':'Meer Sheikh','role':'Technology Architect & AI Lead','image':'meer-sheikh.jpg','summary':'Builds intelligent automation, custom software, and AI architecture with a focus on performance, reliability, and longevity.'},
]
works = '''<section class="portfolio-showcase people-portfolio" id="portfolio" aria-labelledby="portfolio-heading"><div class="portfolio-stage"><div class="portfolio-backdrop"><div class="portfolio-rail portfolio-rail-left"><span class="portfolio-pill">✳ &nbsp; THE PEOPLE BEHIND THE WORK</span><p>Two people. No layers. The strategist and the architect stay close to every project.</p></div><h1 id="portfolio-heading">Portfolio<span>.</span></h1><span class="portfolio-rail portfolio-rail-right">02 PEOPLE <span aria-hidden="true">↗</span></span></div><div class="portfolio-cards">'''
for i,person in enumerate(people,1):
    works += f'''<article class="portfolio-card person-card" data-portfolio-card><div class="portfolio-card-media"><img src="assets/{person['image']}" alt="{e(person['name'])}" loading="lazy"></div><div class="portfolio-card-caption"><div class="portfolio-card-top"><span>0{i} / 02</span><span>{e(person['role']).upper()}</span></div><h2>{e(person['name'])}</h2><p>{e(person['summary'])}</p></div></article>'''
works += '''</div></div><div class="portfolio-outro" id="portfolio-end"><span>02 / PORTFOLIO</span><a href="about.html#team" data-page-link>More about the studio <span aria-hidden="true">↗</span></a></div></section><section class="page-cta paper-grid section-pad"><h2>Talk to the people building your system.</h2><a class="pill" href="contact.html" data-page-link>Start a conversation <span aria-hidden="true">↗</span></a></section>'''
page('Portfolio','Meet Sumit Thakur and Meer Sheikh, the two people behind Avantage AI.',works,'works.html',active='Portfolio',body_class='portfolio-page')

projects = title_block('03 / PROJECTS','Thoughtful systems,<br><mark>real impact.</mark>','CRM and accounting systems, ERP, PLM, mobile apps, websites, and automation tools built for real business operations.')
projects += '<section class="work-archive section-pad"><div class="section-label"><span>PROJECT ARCHIVE / 08</span><span class="scribble">open each story ↗</span></div><div class="archive-grid">'
for i,project in enumerate(PROJECTS,1):
    ...
    projects += f'''<a class="archive-card" href="projects/{project['slug']}.html" data-page-link><div class="archive-image">{image}<span>0{i}</span></div><div class="archive-meta"><span class="case-category">{e(project['category'])}</span><h2>{e(project['title'])}</h2><p>{e(project['summary'])}</p><b aria-hidden="true">↗</b></div></a>'''
projects += '</div></section><section class="page-cta paper-grid section-pad"><h2>Have a process we can improve?</h2><a class="pill" href="contact.html" data-page-link>Start a conversation <span aria-hidden="true">↗</span></a></section>'
page('Projects','Selected Avantage AI projects across travel, manufacturing, steel, real estate, games, minerals and marketing.',projects,'projects.html',active='Projects')
...
for i,project in enumerate(PROJECTS,1):
    ...
    body = f'''<section class="content-hero paper-grid section-pad"><div class="section-label"><span>PROJECT / 0{i}</span><a href="../projects.html" data-page-link>ALL PROJECTS ↗</a></div><span class="case-category">{e(project['category'])}</span><h1>{e(project['title'])}<span class="heading-dot">.</span></h1><p>{e(project['summary'])}</p></section><section class="project-detail section-pad"><div class="project-visual">{image}</div><div class="project-facts"><div><span>CLIENT</span><strong>{e(project['client'])}</strong></div><div><span>PROJECT TYPE</span><strong>{e(project['category'])}</strong></div></div><div class="project-explanation"><h2>Built for the real operation.</h2><p>{e(project['summary'])}</p></div></section><section class="related section-pad paper-grid"><div class="section-label"><span>RELATED PROJECTS</span><span class="scribble">keep exploring</span></div><div class="related-links">{related}</div></section>'''
    page(project['title'],project['summary'],body,f'projects/{project["slug"]}.html',prefix='../',active='Projects')
...
print('Generated',6 + len(PROJECTS) + len(ARTICLES),'content pages')
